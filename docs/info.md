...
Check whether any 8-bit binary number is displayed correctly on the 7-segment display as a sequence of digits (hundreds, tens, and ones) followed a decimal point as separator. The decimal numbers 0, 12, 77, 167, 189, 243, and 255 have been tested in the test vectors.
